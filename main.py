...
def menu():
    ...
    while True:
        ...
        print("2. Уменьшить изображение до 200x200 пикселей")
        print("3. Сохранить изображение с текущей датой")
        print("4. Применить фильтр контуров")
        print("5. Добавить текст 'Вариант 3'")
        ...
        if res == "1":
            ...
            if processor and processor.image:
                ...
                print("Сначала примените фильтр к изображению!")
